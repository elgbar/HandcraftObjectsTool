...
import no.uib.inf219.gui.backend.cb.simple.BooleanClassBuilder
import no.uib.inf219.gui.backend.cb.simple.ByteClassBuilder
import no.uib.inf219.gui.backend.cb.simple.CharClassBuilder
import no.uib.inf219.gui.backend.cb.simple.DoubleClassBuilder
import no.uib.inf219.gui.backend.cb.simple.EnumClassBuilder
import no.uib.inf219.gui.backend.cb.simple.FloatClassBuilder
import no.uib.inf219.gui.backend.cb.simple.IntClassBuilder
import no.uib.inf219.gui.backend.cb.simple.LongClassBuilder
import no.uib.inf219.gui.backend.cb.simple.ShortClassBuilder
...
fun createClassBuilder(
    ...
    val cb = (
        if (type.rawClass.kotlin.javaPrimitiveType != null) {
    ...
    if (cb is ParentClassBuilder) {
        item.children.setAll(
            cb.getChildren().map { (key, childCb) ->
