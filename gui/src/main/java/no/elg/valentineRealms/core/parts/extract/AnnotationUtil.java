...
import no.uib.inf219.api.annontation.NoDefaultValue;
...
//        Set<String> keySet = keys.stream().map(no.elg.valentineRealms.core.parts.extract.AnnotationUtil::getAttributePath).collect(Collectors.toSet());
//        if (isListElem) {
